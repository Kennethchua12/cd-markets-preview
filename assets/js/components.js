...
(function () {
  ...
  function buildFooter() {
    return ''
      ...
      + '          <span class="topbar-brand-name">CD Markets</span>\n'
      + '        </a>\n'
      + '        <p>CD Markets Limited<br>香港持牌貴金屬交易商<br>商業登記號 63576919<br>Established 2014 · Hong Kong</p>\n'
      ...
      + '      <strong style="margin-left:12px">RESTRICTED</strong>CD Markets 不接受來自美國、加拿大、伊朗、北韓等地區居民的申請。\n'
      + '    </div>\n'
      + '\n'
      + '    <div class="footer-bottom">\n'
      + '      <div>© 2026 CD MARKETS LIMITED · ALL RIGHTS RESERVED</div>\n'
